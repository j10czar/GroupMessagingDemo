...
public class ClientTextAreaOutputStream
...
public ClientTextAreaOutputStream(JTextArea txtara) {
    this(txtara,1000);
    }

public ClientTextAreaOutputStream(JTextArea txtara, int maxlin) {
